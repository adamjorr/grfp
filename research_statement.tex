...
%%%WIP!!!
%%I think the best idea for this is: most variant callers for somatic mutations are designed to work with cancer samples, which behave fundamentally differently from normal tissues. So we may be unable to use standard methods and may need something different.
%%

 a De Bruijn graph mutation caller called DiscoSNP++\textsuperscript{5} to identify mutations in each of the samples.
%During DNA sequencing, the DNA is randomly shredded. The sequence of each small fragment, called a read, is generated.
...
I will also use a traditional reference-based approach to compare the De Bruijn graph and reference-based methods. % Can cut down this paragraph if necessary
